  ...
  return (
    <section id="booking-section" className="py-28 bg-dwild-jungle text-dwild-offwhite border-t border-dwild-sand/10 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-6 md:px-12 relative z-10">
        ...
        {submitted ? (
          <div className="bg-dwild-dark border border-dwild-sand p-10 text-center shadow-2xl space-y-6 animate-fadeIn">
          ...
          <form onSubmit={handleSubmit} className="bg-dwild-dark border border-dwild-sand/20 p-8 sm:p-12 shadow-2xl space-y-8">
            ...
            <div className="pt-4 border-t border-dwild-sand/15 flex flex-col sm:flex-row items-center gap-4">
              <button
                type="submit"
                className="w-full sm:w-1/2 inline-flex items-center justify-center gap-2 text-xs tracking-[0.2em] uppercase font-semibold text-dwild-black bg-dwild-sand py-4 border border-dwild-sand hover:bg-dwild-offwhite hover:border-dwild-offwhite transition-all shadow-xl"
              >
              ...
              {whatsappUrl ? (
                <a
                  ...
                  className="w-full sm:w-1/2 inline-flex items-center justify-center gap-2 text-xs tracking-[0.2em] uppercase font-semibold text-white bg-[#25D366] border border-[#25D366] py-4 hover:bg-[#20bd5a] transition-all shadow-xl"
                >
