    ...
    <section className="py-28 bg-dwild-jungle text-dwild-offwhite border-t border-dwild-sand/10 overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 relative group" data-cursor="EXPLORE">
            <div className="relative aspect-[4/5] sm:aspect-[16/10] w-full overflow-hidden border border-dwild-sand/20 shadow-2xl">
              <img
          ...
          <div className="lg:col-span-5 flex flex-col justify-center space-y-6">
            ...
            <div className="pt-4">
              <Link
                ...
                className="group inline-flex items-center gap-3 text-xs tracking-[0.25em] font-semibold text-dwild-black bg-dwild-sand px-8 py-4 border border-dwild-sand hover:bg-dwild-offwhite transition-all shadow-xl"
              >
