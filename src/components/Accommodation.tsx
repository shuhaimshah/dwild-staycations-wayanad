        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          {staysData.map((stay) => (
            <div
              ...
              className="group cursor-pointer bg-dwild-jungle border border-dwild-sand/15 overflow-hidden flex flex-col justify-between transition-all duration-500 hover:border-dwild-sand hover:shadow-glow"
            >
              {/* Image Panel */}
              ...
              {/* Content Panel (Content moves upward on hover) */}
              <div className="p-8 flex flex-col justify-between flex-grow transform transition-transform duration-500 group-hover:-translate-y-1">
                <div>
