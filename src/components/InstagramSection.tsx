      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-end justify-between mb-12 border-b border-dwild-sand/15 pb-8">
          ...
          <a
            ...
            className="mt-4 sm:mt-0 inline-flex items-center gap-2 text-xs tracking-[0.2em] uppercase font-semibold text-dwild-black bg-dwild-sand px-6 py-3.5 hover:bg-dwild-offwhite transition-colors shadow-lg"
          >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {instaPosts.map((post) => (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group relative aspect-square overflow-hidden bg-dwild-jungle border border-dwild-sand/15 block"
            >
              <img
                src={post.image}
